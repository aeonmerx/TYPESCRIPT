...
try {
    ...
    var resultado = 10 / 0; // Esto lanzará una excepción de división por cero
...
try {
    var resultado = dividir(10, 0); // Esto lanzará una excepción personalizada
...
try {
    var datos = JSON.parse("esto no es un JSON"); // Esto lanzará una excepción de análisis JSON
    console.log(datos);
}
catch (error) {
...
var MiError = /** @class */ (function (_super) {
    __extends(MiError, _super);
